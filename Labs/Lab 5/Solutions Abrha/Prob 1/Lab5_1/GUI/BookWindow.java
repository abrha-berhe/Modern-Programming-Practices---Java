...
public class BookWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			RuleSet addressRules = RuleSetFactory.getRuleSet(BookWindow.this);
			try {
				addressRules.applyRules(BookWindow.this);
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(BookWindow.this, "Error: " + e.getMessage(), "Error",
