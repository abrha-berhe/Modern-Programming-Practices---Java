...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			RuleSet addressRules = RuleSetFactory.getRuleSet(CDWindow.this);
			try {
				addressRules.applyRules(CDWindow.this);
			} catch (RuleException e) {
				JOptionPane.showMessageDialog(CDWindow.this, "Error: " + e.getMessage(), "Error",
